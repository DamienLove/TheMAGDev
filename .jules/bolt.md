...
## 2024-05-22 - [Parallelizing independent async loops]
**Learning:** Sequential async operations within loops block the event loop and degrade performance.
**Action:** When computing independent items in a collection, parallelize using `Promise.all` while ensuring any synchronous states are handled appropriately.
