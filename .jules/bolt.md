...
## 2026-05-02 - [Parallelize Git Blob SHA Computation]
**Learning:** Sequential await loops for hashing large numbers of files caused significant delay during git change detection.
**Action:** Parallelize independent async operations using Promise.all to improve performance.
