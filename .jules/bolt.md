...
## 2025-04-29 - [Parallelize Git Blob SHA Computations]
**Learning:** Sequentially awaiting cryptographic hash computations (like SHA-1) on large numbers of files creates a significant performance bottleneck.
**Action:** Use `Promise.all` to execute these independent hash computations in parallel to improve performance by ~50% in benchmarks.
