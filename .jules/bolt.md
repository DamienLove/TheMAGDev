...
## 2026-04-05 - Referential Equality in Set State Updates
...
**Action:** Always check for existing values in Set/Map before creating new references during state updates in high-frequency React contexts.
