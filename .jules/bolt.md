...
## 2026-04-19 - Set/Map Referential Equality
**Learning:** Early returns prevent unnecessary React re-renders.
**Action:** Implement prev.has(path) checks before Set instantiation.
