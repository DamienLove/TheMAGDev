...
## 2026-04-04 - Missing Origin Validation in WebSocketServer
**Vulnerability:** CSWSH leading to RCE in local-agent/server.js due to missing Origin check.
**Learning:** The 'ws' library does not check origins by default. This must be explicitly implemented via 'verifyClient'.
**Prevention:** Always implement 'verifyClient' with a whitelist of allowed origins when creating a WebSocketServer.
