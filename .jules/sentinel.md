...
## 2026-03-30 - Added noopener noreferrer to window.open
**Vulnerability:** Tabnabbing/Referrer leakage via window.open
**Learning:** External links must use noopener,noreferrer to prevent security risks.
**Prevention:** Always add 'noopener,noreferrer' when calling window.open for external links.
