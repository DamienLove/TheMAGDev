...
const FEATURED_EXTENSIONS: MarketplaceExtension[] = [
  ...
  },
  {
    ...
    rating: 4.9,
    ratingCount: 9500,
    publishedDate: Date.now() - 500 * 24 * 60 * 60 * 1000,
    lastUpdated: Date.now() - 10 * 24 * 60 * 60 * 1000,
    scanReport: { safe: true, issues: [], scannedAt: Date.now() },
  },
  {
    manifest: {
      ...
      version: 'stable',
      description: 'Snippets for Next.js (App and Pages router)',
      author: { name: 'Community' },
      license: 'MIT',
      categories: ['snippets'],
      keywords: ['nextjs', 'react', 'snippets'],
      main: 'dist/extension.js',
    ...
    rating: 4.7,
    ratingCount: 8800,
    publishedDate: Date.now() - 400 * 24 * 60 * 60 * 1000,
