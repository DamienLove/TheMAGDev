...
import { REACT_TEMPLATE, NODE_TEMPLATE, STATIC_TEMPLATE, PYTHON_TEMPLATE, RUST_TEMPLATE, VUE_TEMPLATE } from '../src/data/templates';
...
const Projects: React.FC<ProjectsProps> = ({ onSelect, onNavigate }) => {
  ...
  const handleOpenProject = (project: Project) => {
    ...
    if (project.id === 'p-5') template = VUE_TEMPLATE;
    if (project.id === 'p-6') template = PYTHON_TEMPLATE;
    if (project.id === 'p-7') template = RUST_TEMPLATE;
