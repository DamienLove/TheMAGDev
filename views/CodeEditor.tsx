              ...
              >
                ...
                <div className="h-8 bg-zinc-900 border-b border-zinc-800 flex items-center px-4 gap-1 shrink-0">
                  ...
                  <div className="ml-auto flex items-center gap-3">
                    ...
                    <button className="text-zinc-500 hover:text-white" title="New instance" aria-label="New instance"><span className="material-symbols-rounded text-sm">add</span></button>
                    <button
                      onClick={() => setBottomPanelHeight(h => h === 200 ? 350 : 200)}
                      className="text-zinc-500 hover:text-white"
                      title={bottomPanelHeight === 200 ? 'Maximize panel' : 'Restore panel'}
                      aria-label={bottomPanelHeight === 200 ? 'Maximize panel' : 'Restore panel'}
                    >
