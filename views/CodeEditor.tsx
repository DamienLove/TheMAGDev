    ...
    <div className="flex-1 flex flex-col bg-zinc-950 h-full overflow-hidden font-sans relative">
      ...
      <div className="h-10 bg-zinc-900 border-b border-zinc-800 flex items-center justify-between px-3 shrink-0">
        ...
        <div className="flex items-center gap-2">
          ...
          <button className="flex items-center gap-1.5 px-3 py-1 bg-emerald-600/10 hover:bg-emerald-600/20 text-emerald-500 border border-emerald-500/30 rounded text-[10px] font-bold transition-all uppercase tracking-tight" aria-label="Run" title="Run">
            <span className="material-symbols-rounded text-sm">play_arrow</span> Run
          </button>
          <button className="flex items-center gap-1.5 px-3 py-1 bg-amber-600/10 hover:bg-amber-600/20 text-amber-500 border border-amber-500/30 rounded text-[10px] font-bold transition-all uppercase tracking-tight" aria-label="Debug" title="Debug">
