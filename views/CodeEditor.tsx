                        ...
                        {changes.filter(c => c.staged).map((c, i) => (
                          <div key={i} className="flex items-center justify-between px-3 py-1.5 hover:bg-zinc-800 cursor-pointer group">
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              <button onClick={() => toggleStage(c.file)} className="opacity-0 group-hover:opacity-100 text-zinc-500 hover:text-red-400" aria-label="Unstage changes" title="Unstage changes">
                    ...
                    {changes.filter(c => !c.staged).map((c, i) => (
                      <div key={i} className="flex items-center justify-between px-3 py-1.5 hover:bg-zinc-800 cursor-pointer group">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <button onClick={() => toggleStage(c.file)} className="opacity-0 group-hover:opacity-100 text-zinc-500 hover:text-emerald-400" aria-label="Stage changes" title="Stage changes">
              ...
              >
                ...
                <div className="h-8 bg-zinc-900 border-b border-zinc-800 flex items-center px-4 gap-1 shrink-0">
                  ...
                  <div className="ml-auto flex items-center gap-3">
                    ...
                    <button className="text-zinc-500 hover:text-white" aria-label="Add" title="Add"><span className="material-symbols-rounded text-sm">add</span></button>
                    <button
